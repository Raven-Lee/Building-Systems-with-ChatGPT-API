...
category_and_product_response_1 = ai.get_completion_from_messages(messages)
...
def read_string_to_list(input_string):
    ...
    try:
        input_string = input_string.replace("'","\"")#replace single quote with double quote
...
# ]
# final_respondse = ai.get_completion_from_messages(messages)
# print(final_respondse)
